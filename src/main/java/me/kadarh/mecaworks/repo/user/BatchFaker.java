        ...
        for (Chantier c : chantierService.getList()) {
            for (int i = 1; i < 5; i++) {
                chantierBatch = new ChantierBatch(i,
                        ...
                        i == 1 || i == 3 ? 2000000 + 21000 + 1L : 3000000 + 9000 + 1L,
                        i == 2 || i == 1 ? 500000 + 9000 + 1L : 500000 + 10000 + 1L,
                        8f + i / 2,
                        i == 2 || i == 1 ? 9098000 + 9000 + 1L : 9807000 + 10000 + 1L,
                        i == 2 || i == 1 ? 8000 + 9000 + 1L : 5000 + 2000 + 1L,
                        c);
            ...
            for (int i = 5; i <= 12; i++) {
                chantierBatch = new ChantierBatch(i,
                        ...
                        i == 7 || i == 5 || i == 12 ? 3000000 + 2100000 + 1L : 4000000 + 900000 + 1L,
                        i == 7 || i == 9 ? 1350000 + 1L : 590000 + 1L,
                        8.5f + i / 4,
                        i == 7 || i == 8 ? 9098000 + 9000 + 1L : 9807000 + 10000 + 1L,
                        i == 9 || i == 8 || i == 11 ? 8000 + 9000 + 1L : 5000 + 2000 + 1L,
                        c);
                chantierBatchRepo.save(chantierBatch);
            }
        }
